...
export const About = () => {
    return (
        <div className={styles.container}>
            <p>Если вам вдруг интересно, чем я занимаюсь то вот краткий перечень того, где меня можно встретить:</p>
            <br />
            ...
            <p>В остальном, встречи с друзьями, посещение различных развлекательных мест города.</p>
        </div>
    );
};
