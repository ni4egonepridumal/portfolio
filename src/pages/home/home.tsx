        ...
        <div className={styles.container}>
            {showExperience && <>
                <div style={{ fontSize: "22px" }} className={styles.container_inner}>
                    ...
                    <br />
                    <p>Имею опыт кросс-браузерной, адаптивной и резиновой верстки без использования библиотек, в том числе по методологии БЭМ.
                    </p>
                    <br />
            ...
            {showStack &&
                <div className={styles.general_mobile}>
